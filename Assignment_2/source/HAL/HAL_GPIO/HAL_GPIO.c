...
static HAL_GPIO_Erorr_E HAL_GPIO_Set_State(FGPIO_Type* GPIOx,uint32_t Pin_select);

static HAL_GPIO_Erorr_E HAL_GPIO_Clear_State(FGPIO_Type* GPIOx,uint32_t Pin_select);
...
static HAL_GPIO_Erorr_E HAL_GPIO_Set_State(FGPIO_Type* FGPIOx,uint32_t Pin_select)
{
	HAL_GPIO_Erorr_E E_retval = HAL_GPIO_SUCCESS;
...
/**
  ...
  * @retval 0 : SUCCESS
			1 : ERROR
  */
static HAL_GPIO_Erorr_E HAL_GPIO_Clear_State(FGPIO_Type* FGPIOy,uint32_t Pin_select)
{
	HAL_GPIO_Erorr_E E_retval = HAL_GPIO_SUCCESS;
